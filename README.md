# TPE Azure IoT Central Demo Application
Azure IoT Central demo application on ThingsPro Edge V2.2.X

| Name         | Azure IoT Central Demo Application on ThingsPro Edge |
| ------------ | ---------------------------------------------------- |
| Version      | 1.2 build 650                                        |
...
- Download application binary from : https://thingspro.blob.core.windows.net/software/edge/others/aic_1.2-650_armhf.mpkg

- Install application binary on Moxa IIoT Gateway Linux console by below command：
