...
class iotHubHandler:        
    ...
    def desired_property_action(self, name, value, version):
        ...
        if name == "general_hostName":
            ...
            print("update general_hostName name:" + str(value) + "; result:" + str(data_dict["ac"]) + "; message:" + str(data_dict["ad"]))
            ...
            data_dict["av"] = version
            data_dict["value"] = value
            print("update service_ssh service:" + str(value) + "; result:" + str(data_dict["ac"]) + "; message:" + str(data_dict["ad"]))
            ...
            data_dict["av"] = version
            data_dict["value"] = value
            print("update LAN2 IP:" + str(value) + "; result:" + str(data_dict["ac"]) + "; message:" + str(data_dict["ad"]))
        else:            
